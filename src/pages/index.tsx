  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash Your Team's Potential with HR Management Application, Your Ultimate Partner in Streamlining HR Processes and Empowering People"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash Your Team's Potential with HR Management Application, Your Ultimate Partner in Streamlining HR Processes and Empowering People`}
            </Text>
            <Box
